...
public class Telecom {
	...
	public void setupExtent() {
		...
		extent.setSystemInfo("Tester", "Priya Mathur");
	}
	...
	public void getUserProfile() {
		...
		Response res = given().header("Authorization", "Bearer " + authToken)
	...
	public void updateUser() {
		...
		Response res = given().header("Authorization", "Bearer " + authToken).contentType("application/json")
				.body("{ \n" + "\"firstName\": \"Updated\", \n" + "\"lastName\": \"Username\", \n"
	...
	public void getContactList() {
		...
		Assert.assertEquals(res.getStatusLine(), "HTTP/1.1 200 OK");
		System.out.println("Status Message is: " + res.getStatusLine());
		// Validation For Response is Array
	...
	public void getContact() {
		...
		Response res = given().header("Authorization", "Bearer " + authToken).when()
